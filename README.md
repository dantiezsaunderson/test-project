...
- `BLOFIN_ICC_STRUCTURE_SWING_COUNT` - swings to confirm trend (default 2)
...
Optimize ICC parameters for BTC:
```bash
node skills/icc-backtest/optimize.js --inst BTC-USDT --entry 5m --high 1H --entry-limit 6500 --high-limit 800
```
